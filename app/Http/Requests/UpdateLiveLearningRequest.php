...
class UpdateLiveLearningRequest extends FormRequest
{
    /**
...
public function authorize(): bool
{
    ...
    public function rules(): array
    {
        return [
            ...
            'thumbnail_url' => 'sometimes|required|string|url',
            ...
            'zoom_link' => 'sometimes|required|string|url',
            'community_group_link' => 'sometimes|required|string|url',
